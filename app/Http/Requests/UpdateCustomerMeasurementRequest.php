...
class UpdateCustomerMeasurementRequest extends FormRequest
{
    /**
    ...
    {
        $customerMeasurementId = $this->route('customer_measurement');
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('customer_measurements', 'code')->ignore($customerMeasurementId)
            ],
